...
void itemdb_read_groups(void) {
	...
	const char *config_filename = "db/Item_DB/GroupList.conf"; // FIXME hardcoded name
	const char *itname;
	int i = 0, count = 0, c;
...
void itemdb_read_packages(void) {
	...
	const char *config_filename = "db/Item_DB/Packages.conf"; // FIXME hardcoded name
	const char *itname;
...
void itemdb_read_chains(void) {
	...
	const char *config_filename = "db/Item_DB/ChainList.conf"; // FIXME hardcoded name
	int i = 0, count = 0;
